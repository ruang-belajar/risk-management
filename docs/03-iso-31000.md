...
1. [Software Development](contoh-aplikasi-software-development.md)
2. [Cyber security](contoh-aplikasi-cyber-security.md)
...
1. Buat rancangan penerapan risk management untuk bidang operasional, sistem informasi dan keuangan untuk bidang usaha berikut:
	...
	2. Bengkel motor
2. Pelajari tentang ISO 27000. Analisis Risiko contoh kasus [Software Development](contoh-aplikasi-software-development.md) dan [Cyber security](contoh-aplikasi-cyber-security.md) menggunakan ISO 27000
